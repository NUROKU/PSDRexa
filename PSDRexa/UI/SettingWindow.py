...
class SettingWindow:
    ...
    def execute(self):
        ...
        dlg_modal.title("settings")  # ウィンドウタイトル
        ...
        def save_settings():
            ...
            messagebox.showinfo("Info", "Settings have been saved. Exit the application.")
        ...
        folder_button = tk.Button(frame1, text="Image output destination", command=select_folder)
        ...
        checkbox = tk.Checkbutton(dlg_modal, text="Output images in the size of the base file", variable=checkbox_var)
        ...
        checkbox_2 = tk.Checkbutton(dlg_modal, text="Preview in the size of the base file", variable=checkbox_var_2)
        ...
        checkbox_3 = tk.Checkbutton(dlg_modal, text="Use psdtoolkit feature", variable=checkbox_var_3)
